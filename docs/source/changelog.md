...
- Update CYTHON_SECURITY_PROFILE to 'STRICT' for enhanced security (`66a659c`)
## [0.17.2] - February 07, 2026


### Changed

- Update func1 to use NDArray type for better type hinting (`98b73a9`)
## [0.17.1] - February 07, 2026


### Changed

- Update numpy imports to use specific types for better clarity (`d0b83df`)
## [0.17.0] - February 07, 2026


### Added

- Add .pyi type stubs generation and update numpy dependency in pyproject.toml (`e25be93`)
## [0.16.0] - February 07, 2026


### Fixed

- Update CIBW_SKIP to exclude only specific platforms (`e4e11bc`)

### Added

- Add Cython security profiles for compilation settings (`b2d2428`)
## [0.15.0] - February 07, 2026


### Fixed

- Remove unreleased section from changelog template (`3b271e8`)
- Add missing --strip option to git-cliff command in serve-docs.sh (`4a1e75b`)

### Documentation

- Update serve-docs.sh comments for clarity (`c599f5b`)

### Added

- Add initial draft for Test → Promote → Production pattern documentation (`797d62d`)
- Enhance changelog configuration with additional commit parser patterns (`132df28`)

### Changed

- Enhance release and serve-docs scripts with comments and structure (`232bebb`)
## [0.14.0] - February 06, 2026
